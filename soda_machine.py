...
def total_value(args):
    pass


def calculate_coin_value(coin_list, total_value=None):
...
class SodaMachine:
    ...
    def calculate_transaction(self, customer_payment, selected_soda, customer):
        total_payment_value = calculate_coin_value(customer_payment)
        if total_payment_value < selected_soda.price:
            change_value = determine_change_value(total_payment_value, selected_soda.price)
    ...
    def deposit_coins_into_register(self, coin_list, coins_list=None):
